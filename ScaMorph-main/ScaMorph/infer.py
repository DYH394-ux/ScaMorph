...
def main():
    atlas_dir = 'D:/data/IXI_data/IXI_data (2)/IXI_data/atlas.pkl'
    test_dir = 'D:/data/IXI_data/IXI_data (2)/IXI_data/'
    img_size = (160, 192, 224)
    model_idx = -1
    model_folder = 'ScaMorph_ncc1_reg1/'
    ...
    with torch.no_grad():
        ...
        for data in test_loader:
            ...
            y_src, flow = model(torch.cat((x,y),dim=1))
